...
foreign key(cnpj_fornecedor) references fornecedores(cnpj_fornecedor),
...
complemento_enderecofornecedor varchar(500),
referencia_enderecofornecedor varchar(500),
 ...
 */
public class EnderecosFornecedores extends javax.swing.JFrame {
    ...
    private void cadastrar() {
        String sql = "insert into enderecos_fornecedores(rua_enderecofornecedor,numero_enderecofornecedor,bairro_enderecofornecedor,complemento_enderecofornecedor,referencia_enderecofornecedor,cep_enderecofornecedor,cidade_enderecofornecedor,estado_enderecofornecedor) values(?,?,?,?,?,?,?,?)";
        try {
    ...
    private void atualizar() {
        String sql = "update enderecos_fornecedores set rua_enderecofornecedor=?,numero_enderecofornecedor=?,bairro_enderecofornecedor=?,complemento_enderecofornecedor=?,referencia_enderecofornecedor=?,cep_enderecofornecedor=?,cidade_enderecofornecedor=?,estado_enderecofornecedor=? where id_enderecofornecedor=?";
        try {
            entrada = conexao.prepareStatement(sql);
            entrada.setString(1, resposta_rua.getText());
            entrada.setString(2, resposta_numero.getText());
    ...
    private void initComponents() {
        ...
        texto_cnpjfornecedor = new javax.swing.JLabel();
        resposta_cnpjfornecedor = new javax.swing.JLabel();

        texto_status.setText("Ativo:");

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Sistema Restaurante - Endereços de Fornecedores");
        setResizable(false);
        ...
        texto_cnpjfornecedor.setText("CNPJ do Fornecedor:");

        resposta_cnpjfornecedor.setText("CNPJ");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(texto_cnpjfornecedor)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(resposta_cnpjfornecedor)))
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        resposta_cnpjfornecedor.setText(CNPJ_FORNECEDOR);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnderecosFornecedores.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnderecosFornecedores().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel resposta_cnpjfornecedor;
    ...
    private javax.swing.JLabel texto_cnpjfornecedor;
